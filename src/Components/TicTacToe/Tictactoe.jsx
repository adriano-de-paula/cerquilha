...
const Tictactoe = () => {
    ...
    const won = (winner) => {
        setLock(true);
        if(winner === "x") {
            titleRef.current.innerHTML = `Parabéns <img src='${cross_icon}'>: Você venceu!`;
        } else {
            titleRef.current.innerHTML = `Parabéns <img src='${circle_icon}'>: Você venceu!`;
        }
    }
    ...
    const reset = () => {
        setLock(false);
        data = ["", "", "", "", "", "", "", "", ""];
        titleRef.current.innerHTML = 'Cerquilha <span>#</span>';
    ...
    return (
        <div className="container">
            <h1 className="title" ref={titleRef}>Cerquilha <span>#</span></h1>
            <div className="board">
                <div className="row1">
            ...
            <button className="reset" onClick={() => {reset()}}>Jogar de Novo</button>
        </div>
    )
}
